                ...
                <Row>
                   ...
                   <ScrollAnimation animateIn="fadeInDown" delay={500} animateOnce="true" >
                        <div class="meme_soundboard allImages">
                            ...
                            <br/>
                            <br/>
                            <a class="cardWord card" style={{ backgroundColor: "black" }} href="https://youtu.be/4_4Qy8zlrQk" target="_blank">
                    ...
                    <ScrollAnimation animateIn="fadeInDown" delay={500} animateOnce="true">
                        <div class="rjavacado allImages">
                            ...
                            <br/>
                            <br />
                            <a class="cardWord card" style={{ backgroundColor: "black" }} href="https://youtu.be/aHvqi0t7nbI" target="_blank">
                    ...
                    <ScrollAnimation animateIn="fadeInDown" delay={500} animateOnce="true">
                        <div class="hireadams allImages">
                            ...
                            <br/>
                            <br/>
                            <a class="cardWord card" style={{ backgroundColor: "black" }}  href="http://www.hireadams.com/" target="_blank">
                    ...
                    <ScrollAnimation animateIn="fadeInUp" delay={500} animateOnce="true">
                        <div class="e_joker allImages">
                            ...
                            <br/>
                            <br/>
                            <a class="cardWord card" style={{ backgroundColor: "black" }} href="http://www.gingercreek.org/wp-content/uploads/2015/08/video-coming-soon.jpg" target="_blank">
                    ...
                    <ScrollAnimation animateIn="fadeInUp" delay={500} animateOnce="true">
                        <div class="we_haul allImages">
                            ...
                            <br/>
                            <br />
                            <a class="cardWord card" style={{ backgroundColor: "black" }} href="https://myaccess.southern.edu/mvc/wehaul" target="_blank">
